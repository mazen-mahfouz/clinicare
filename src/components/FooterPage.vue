    ...
    <div class="bg-[#46439b] p-[10px_40px] md:p-[10px_80px] text-white">
      ...
      <div class="w-full sm:mt-[50px] flex justify-center items-center flex-col gap-[15px]">
        <ul class="flex justify-center items-center flex-wrap gap-y-[20px]">
          <li class="text-[14px] hover:text-sky-200 cursor-pointer transition ease-in px-[15px] border-l border-white">عن كلينيكير </li>
          <li class="text-[14px] hover:text-sky-200 cursor-pointer transition ease-in px-[15px] border-l border-white">سياسة الخصوصية </li>
          <li class="text-[14px] hover:text-sky-200 cursor-pointer transition ease-in px-[15px] border-l border-white">الشروط والأحكام</li>
          <li class="text-[14px] hover:text-sky-200 cursor-pointer transition ease-in px-[15px]">تواصل معنا</li>
        </ul>
      </div>
    </div>
    <div class="bg-[#111111] w-full p-[20px] flex justify-center items-center text-[12px] text-white text-center">
