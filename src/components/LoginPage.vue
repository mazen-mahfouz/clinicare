                      ...
                      <h1 ref="error_login" class="hidden text-[14px] font-bold leading-tight tracking-tight text-center text-[red] mb-[30px]">اكتب البيانات بشكل صحيح !!</h1>
                        ...
                        <ValidationProvider name="Name" rules="required|min:8" :custom-messages="{required: 'اكتب كلمة السر !', min: 'لا تقل عن 8 احروف '}" v-slot="{ errors }">
                          <div class="w-full flex justify-between items-center">
                            ...
                            <router-link to="/forget-password" class="font-medium text-[#5599f9] text-[14px] hover:underline">نسيت كلمة المرور</router-link>
                          </div>
                        ...
                        <p class="text-sm font-light text-gray-500 ">
                          لا تملك حساباً في المنصة؟ <router-link to="/register" class="font-medium text-primary-600 hover:underline">يمكنك التسجيل الآن </router-link>
                        </p>
                    </form>
                </ValidationObserver>
              </div>
